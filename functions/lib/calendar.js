...
exports.updateCalendarEventTitle = updateCalendarEventTitle;
exports.deleteCalendarEvent = deleteCalendarEvent;
exports.updateCalendarEventTime = updateCalendarEventTime;
exports.handleCalendarStatusChange = handleCalendarStatusChange;
/**
 ...
 */
function getCalendarClient(serviceAccountKey) {
 ...
 * カレンダーイベントのタイトルを更新
 */
async function updateCalendarEventTitle(params) {
    try {
 ...
 * カレンダーイベントの日時を更新
 */
async function updateCalendarEventTime(params) {
    try {
        const calendar = getCalendarClient(params.serviceAccountKey);
        const requestBody = {};
        if (params.startTime && params.endTime) {
 ...
 * ステータス変更に応じたカレンダー処理
 */
async function handleCalendarStatusChange(params) {
